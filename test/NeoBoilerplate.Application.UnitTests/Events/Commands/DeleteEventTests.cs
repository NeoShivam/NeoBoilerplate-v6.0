...
using NeoBoilerplate.Application.Features.Events.Commands.DeleteEvent;
using NeoBoilerplate.Application.UnitTests.Mocks;
...
namespace NeoBoilerplate.Application.UnitTests.Events.Commands
{

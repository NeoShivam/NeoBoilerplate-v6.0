using NeoBoilerplate.Identity.Seed;
using NeoBoilerplate.Identity.UnitTests.Fakes;
using NeoBoilerplate.Identity.UnitTests.Mocks;
using Moq;
using System;
...
namespace NeoBoilerplate.Identity.UnitTests.Seed
{

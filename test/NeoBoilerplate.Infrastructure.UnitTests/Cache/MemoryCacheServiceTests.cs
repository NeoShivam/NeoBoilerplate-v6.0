using NeoBoilerplate.Application.Models.Cache;
using NeoBoilerplate.Infrastructure.Cache;
using NeoBoilerplate.Infrastructure.UnitTests.Mocks;
using Microsoft.Extensions.Options;
using Shouldly;
using Xunit;

namespace NeoBoilerplate.Infrastructure.UnitTests.Cache
{
